  ...
  if ( ! has_action('navbar_search') ) {
    ...
    <form class="ms-1 md-flex" role="search" method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>">
      <div class="input-group">
        ...
        <button type="submit" id="searchsubmit" value="<?php esc_attr_x('Search', 'aitech') ?>" class="btn btn-outline-secondary">
...
function aitech_bottomline() {
    ...
    <div class="container-xxl">
      <div class="row pt-3">
        ...
        <div class="col-sm">
          <p class="text-center text-sm-end"><a href="https://github.com/zenithcoder/aitech">aitech</a> theme for WordPress</p>
        </div>
      </div>
    </div>
		<?php		
