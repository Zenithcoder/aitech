...
the_ID() ?>" <?php
post_class("wrap-md entry-content pt-5"); ?> >
    <header>
        <?php
        the_post_thumbnail(); ?>
    ...
    <section>
        ...
        if (!is_front_page()) { ?>
            <div class="text-muted mb-3">
                ...
                <i class="bi bi-chat-text"></i> <a href="<?php
                comments_link(); ?>"><?php
                    printf(
                        _nx('One Comment', '%1$s Comments', get_comments_number(), '', 'aitech'),
