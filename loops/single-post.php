...
<div class="container-fluid pt-5 bg-primary hero-header mb-5" id="post_<?php the_ID()?>">
        <div class="container pt-5">
            <div class="row g-5 pt-5">
                ...
                <div class="col-lg-6 align-self-end text-center text-lg-end">
                    <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/hero-img.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="header-metas d-flex justify-content-center align-items-center my-5 text-muted">
        ...
        <div class="pe-3 d-flex align-items-center">
          ...
          <div class="me-1 border rounded-circle overflow-hidden">
            <?php //aitech_author_avatar(); ?>
          </div>
          <?php _e('By', 'aitech'); echo '&nbsp;'; the_author_posts_link(); ?>
        </div>

        <div class="pe-3">
          <i class="bi bi-calendar3"></i>
          <?php //aitech_post_date(); ?>
        </div>
  ...
  <section class="wrap-md author-bio d-flex border-top border-bottom py-5">
    <div class="border rounded-circle overflow-hidden">
      <?php //aitech_author_bio_avatar(); ?>
    </div>
    <div class="ms-3">
      <p class="h4 author-name"><?php _e('Author: ', 'aitech'); the_author(); ?></p>
      <?php if (true) {
        ?>
        <div class="author-description"><?php echo 'AB' ?></div>
        <?php
      } ?>
      <p class="author-other-posts mb-0"><?php _e('Other posts by ', 'aitech'); the_author_posts_link(); ?></p>
    </div>
  </section><!-- /.author-bio -->
